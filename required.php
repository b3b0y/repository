...
<body>
    ...
    <div class="row-fluid">
      ...
      <div class="row-fluid">
        <div class="login-box">
          <div class="icons">
            <a href="login.php"><i class="halflings-icon off"></i> Logout</a>
          </div>
          ...
          ?>
          <center>Welcome <b><? echo $row['FName'] .' '.$row['Mname'] .' '. $row['LName']; ?></b> you are required to change your Username and Password</center>
          <form class="form-horizontal" action="php/process_required.php" method="post">
            <fieldset>
              ...
              <div class="button-login">  
                <button type="submit" name="commit"  class="btn btn-primary">Next</button>
              </div>
              <div class="clearfix"></div>
          </form>
